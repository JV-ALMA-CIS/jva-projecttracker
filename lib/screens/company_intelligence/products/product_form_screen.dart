...
/// doc comment. Product.businessUnitId is a required single field (unlike
/// every other Company Intelligence relationship, which is a list), so this
/// form's Business Unit picker is a required dropdown, not a
/// `RelationshipPicker` multi-select.
///
...
class ProductFormScreen extends ConsumerStatefulWidget {
  ...
  /// Pre-selects the Business Unit when creating a product from within a
  /// Business Unit Workspace context — optional, still changeable in the
  /// form.
...
class _ProductFormScreenState extends ConsumerState<ProductFormScreen> {
  ...
  void initState() {
    super.initState();
    _businessUnitId = widget.businessUnitId;
  ...
  void _seedFrom(Product? p) {
    ...
    _status = p.status;
    _businessUnitId = p.businessUnitId;
  ...
  Future<void> _save(bool hasBusinessUnits) async {
    ...
    if (_businessUnitId == null || !hasBusinessUnits) return;
  ...
  Widget _buildForm(
    ...
    AppStrings strings,
    AsyncValue businessUnitsAsync,
  ) {
    final businessUnits = businessUnitsAsync.value as List? ?? const [];
    ...
    return Form(
      ...
      child: ListView(
        ...
        children: [
          ...
          businessUnitsAsync.when(
            data: (units) => DropdownButtonFormField<String>(
              initialValue: _businessUnitId,
              decoration: InputDecoration(
                labelText: strings.fieldProductBusinessUnit,
              ),
              items: [
              ...
              onChanged: units.isEmpty
                  ? null
                  : (v) => setState(() => _businessUnitId = v),
              validator: (v) => v == null ? strings.requiredValidator : null,
            ),
          ...
          SizedBox(
            ...
            child: FilledButton(
              onPressed: (_saving || !hasBusinessUnits)
                  ? null
