  ...
  factory TenderSource.fromMap(String id, Map<String, dynamic> data) {
    return TenderSource(
      ...
      syncFrequencyMinutes:
          (data['syncFrequencyMinutes'] as num?)?.toInt() ?? 1440,
      ...
      aiQualityScore: (data['aiQualityScore'] as num?)?.toInt(),
      historicalWinRatePercent: (data['historicalWinRatePercent'] as num?)
          ?.toDouble(),
      opportunitiesImported:
          (data['opportunitiesImported'] as num?)?.toInt() ?? 0,
      opportunitiesPursued:
          (data['opportunitiesPursued'] as num?)?.toInt() ?? 0,
