...
/// Executive-summary KPIs for one Industry — mirrors `TechnologyInsights`/
/// `CapabilityInsights` exactly. See `IndustryWorkspaceScreen`.
...
IndustryInsights deriveIndustryInsights({
