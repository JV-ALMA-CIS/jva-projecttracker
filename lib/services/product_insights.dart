...
/// Executive-summary KPIs + AI strategic-review rollup for one Product,
/// derived purely from its own opportunities/submissions already loaded
/// elsewhere — no new Firestore reads, no new AI call. Mirrors
/// `BusinessUnitInsights` exactly, one level down the Company Intelligence
/// graph. See `ProductWorkspaceScreen`.
...
ProductInsights deriveProductInsights({
