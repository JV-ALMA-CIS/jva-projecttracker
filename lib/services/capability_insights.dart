...
/// Executive-summary KPIs for one Capability — mirrors `ProductInsights`/
/// `ServiceInsights`/`BusinessUnitInsights` exactly. See
/// `CapabilityWorkspaceScreen`.
class CapabilityInsights {
...
CapabilityInsights deriveCapabilityInsights({
