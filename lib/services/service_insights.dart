...
/// Executive-summary KPIs for one Service — mirrors `ProductInsights`/
/// `BusinessUnitInsights` exactly. See `ServiceWorkspaceScreen`.
...
ServiceInsights deriveServiceInsights({
