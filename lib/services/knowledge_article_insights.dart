...
/// Executive-summary KPIs for one Knowledge Article, when it's cited on
/// active opportunities (`Opportunity.knowledgeArticleIds`) — mirrors
/// `ExperienceInsights`/`IndustryInsights` exactly. See
/// `KnowledgeArticleWorkspaceScreen`.
class KnowledgeArticleInsights {
  const KnowledgeArticleInsights({
...
KnowledgeArticleInsights deriveKnowledgeArticleInsights({
  ...
  return KnowledgeArticleInsights(
