...
/// Executive-summary KPIs for one Experience, when it's cited as evidence
/// on active opportunities (`Opportunity.experienceIds`) — mirrors
/// `IndustryInsights`/`TechnologyInsights` exactly. See
/// `ExperienceWorkspaceScreen`.
...
ExperienceInsights deriveExperienceInsights({
